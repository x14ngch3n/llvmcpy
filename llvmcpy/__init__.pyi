...
class LLVMContext:
    ...
    def get_bitcode_module(self, mem_buf: Incomplete) -> LLVMModule: ...
    def get_bitcode_module_provider(self, mem_buf: Incomplete) -> Incomplete: ...
    def parse_bitcode(self, mem_buf: Incomplete) -> LLVMModule: ...
    def parse_ir(self, mem_buf: Incomplete) -> LLVMModule: ...
